...
```{margin}
It is hard to say beforehand where research will lead you, so feel free to change this at any time.
```
<!-- This margin note is about the following paragraph; but annoyingly must come before it, here in the source, for it to be place ± correctly on the page. -->
